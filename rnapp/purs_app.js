...
(function(exports) {
  ...
  var component = (function () {
      var render = function (state) {
          ...
          })()) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(Data_Show.show(Game_Types_Story.showStory)(Script_Scene.story)) ]) ]);
      };
      var initialState = {
          on: false
      };
...
(function(exports) {
  ...
  var Script_Scene = PS["Script.Scene"];
  var Web_DOM_ParentNode = PS["Web.DOM.ParentNode"];                 
  var halogenLoop = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.selectElement("#halogen"))(function (v1) {
          return Halogen_VDom_Driver.runUI(Button.component)(Data_Unit.unit)(Data_Maybe.fromMaybe(v)(v1));
      });
  }));
  var manualEntryPoint = Data_Functor["void"](Effect.functorEffect)(function __do() {
      ...
      return $__unused()((function () {
          if (v instanceof Data_Maybe.Just) {
              return function __do() {
                  ...
                  var v2 = Graphics_Canvas.setFillStyle(v1)("#0000FF")();
          ...
          throw new Error("Failed pattern match at Main line 25, column 3 - line 26, column 3: " + [ v.constructor.name ]);
      })())();
  });
  var asString = Script_Scene.asString;
  exports["asString"] = asString;
  exports["manualEntryPoint"] = manualEntryPoint;
  exports["halogenLoop"] = halogenLoop;
})(PS["Main"] = PS["Main"] || {});